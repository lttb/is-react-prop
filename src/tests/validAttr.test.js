...
describe('validAttr', () => {
  ...
  it('should allow all the html props', () => {
    ...
    // but it need to be allowFullscreen
    expect(validAttr('allowFullScreen')).to.equal(true)
    // removed allowTransparency - work only in IE
    ...
    // remove capture (not supported in chrome?)
  ...
  it('should handle all the SVG props', () => {
    // deprecated expect(validAttr('accentHeight')).to.equal(true)
  ...
  it('should allow all the event handlers', () => {
    ...
    // not supported expect(validAttr('onDragExit')).to.equal(true)
    // not supported expect(validAttr('onDragExitCapture')).to.equal(true)
